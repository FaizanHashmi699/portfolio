    ...
    <Section>
      <div className="grid gap-12 lg:grid-cols-[minmax(0,1fr)_20rem] lg:items-start">
        <div>
          ...
          <p className="text-lead text-muted-foreground mt-4 max-w-2xl">
          ...
          {channels.map((channel) => (
            <Card key={channel.label}>
              <CardContent className="flex items-center gap-3.5 pt-6">
                <span className="bg-ink-50 text-ink-600 dark:bg-ink-950 dark:text-ink-300 flex size-10 shrink-0 items-center justify-center rounded-xl">
