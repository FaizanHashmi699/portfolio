...
export const services: ServiceDefinition[] = [
    ...
    stages: [
      {
        ...
        description: "You upload your passport and photo. We validate both instantly.",
        days: 0,
        actor: "customer",
      },
      {
        ...
        description:
          "We confirm photo spec, passport validity and supporting bookings.",
        days: 1,
        actor: "maqam",
      },
      {
        title: "Submitted to ICP",
        description: "Application lodged through the official channel.",
        days: 0,
        actor: "maqam",
      },
      {
        title: "Government processing",
        description: "ICP reviews and issues the entry permit.",
        days: 3,
        actor: "government",
      },
      {
        title: "Visa issued",
        description: "Your e-visa is delivered to your portal and email.",
        days: 0,
        actor: "maqam",
      },
    ],
    documents: [
      {
        ...
        description:
          "Colour scan, valid at least 6 months beyond your intended entry date.",
      },
      {
        id: "photo",
        label: "Passport photograph",
        description: "White background, 43×55mm, face occupying 70–80% of the frame.",
      },
      {
        id: "ticket",
        label: "Return flight booking",
        description: "Confirmed onward or return ticket.",
      },
      {
        id: "accommodation",
        label: "Accommodation proof",
        description: "Hotel booking or a host's Emirates ID and tenancy contract.",
        conditional: "Required if staying with a resident host.",
      },
    ],
  ...
  },
  {
    ...
    fees: [
      ...
      { ...TYPING, amount: 30, note: "Electronic submission charge." },
      {
        ...
        amount: 150,
        vatable: true,
        note: "Document validation, submission and tracking.",
      },
    ],
    expressSurcharge: 150,
    processingDays: { min: 2, max: 4 },
    ...
    stages: [
      {
        title: "Documents uploaded",
        description: "Passport and photo validated on upload.",
        days: 0,
        actor: "customer",
      },
      {
        title: "Pre-submission check",
        description: "We verify eligibility and supporting documents.",
        days: 1,
        actor: "maqam",
      },
      {
        title: "Submitted to ICP",
        description: "Application lodged officially.",
        days: 0,
        actor: "maqam",
      },
      {
        title: "Government processing",
        description: "ICP reviews and issues.",
        days: 3,
        actor: "government",
      },
      {
        title: "Visa issued",
        description: "E-visa delivered to your portal.",
        days: 0,
        actor: "maqam",
      },
    ],
    documents: [
      {
        id: "passport",
        label: "Passport bio page",
        description: "Valid at least 6 months beyond intended entry.",
      },
      {
        id: "photo",
        label: "Passport photograph",
        description: "White background, 43×55mm.",
      },
      {
        id: "ticket",
        label: "Return flight booking",
      ...
      },
      {
        id: "accommodation",
        label: "Accommodation proof",
        description: "Hotel booking or host documents.",
      },
    ],
    commonRejectionReasons: [
  ...
  },
  {
    ...
    summary:
      "Full free-zone residence visa including medical, Emirates ID and stamping.",
    description:
    ...
    fees: [
      {
        kind: "government",
        label: "Free zone employment entry permit",
        amount: 1150,
        vatable: false,
        note: "Charged by the free-zone authority.",
      },
      {
        kind: "government",
      ...
      {
        kind: "government",
        label: "Emirates ID (2 years)",
        amount: 370,
        vatable: false,
        note: "Federal Authority ID card fee.",
      },
      MEDICAL,
      {
        kind: "third-party",
        label: "Basic health insurance (1 year)",
        amount: 850,
        vatable: true,
        estimated: true,
        note: "Mandatory. Cost varies by age and plan; this is a representative basic plan.",
      },
      TYPING,
      {
        kind: "service",
        ...
        amount: 1500,
        vatable: true,
        note: "End-to-end handling, document validation, appointments and tracking.",
      },
    ],
    ...
    stages: [
      {
        title: "Offer & documents collected",
        description: "Employment offer, passport, photo and qualifications uploaded.",
        days: 0,
        actor: "customer",
      },
      {
        ...
        description:
          "We verify attestation, name consistency and eligibility against MoHRE criteria.",
        days: 1,
        actor: "maqam",
      },
      {
        title: "Entry permit application",
        description: "Submitted to the free-zone authority.",
        days: 5,
        actor: "government",
      },
      {
        title: "Status change or entry",
        description: "You enter on the permit, or change status in-country.",
        days: 2,
        actor: "customer",
      },
      {
        title: "Medical fitness test",
        description: "Blood test and chest X-ray at an approved centre.",
        days: 2,
        actor: "customer",
      },
      {
        title: "Emirates ID biometrics",
        description: "Fingerprints and photo captured at an ICP centre.",
        days: 1,
        actor: "customer",
      },
      {
        title: "Residence stamping",
        description: "Visa endorsed and Emirates ID issued.",
        days: 5,
        actor: "government",
      },
    ],
    documents: [
      ...
      },
      {
        id: "photo",
        label: "Passport photograph",
        description: "White background, meeting ICP specification.",
      },
      {
        id: "offer",
        label: "Employment offer letter",
        description: "Signed offer from your free-zone employer.",
      },
      {
        id: "degree",
        label: "Educational certificate",
        description: "Degree certificate, fully attested.",
        attestationRequired: true,
        conditional: "Required for skilled and professional categories.",
      },
      {
        id: "experience",
        label: "Experience certificates",
        description: "Previous employment letters supporting the declared role.",
        conditional: "Strengthens AI screening outcomes for senior roles.",
      },
    ],
    commonRejectionReasons: [
  ...
  },
  {
    ...
    fees: [
      {
        ...
        vatable: false,
        estimated: true,
        note: "Varies by company category and skill level. Category 2, skill level 3 shown.",
      },
      ...
      MEDICAL,
      {
        ...
        vatable: true,
        estimated: true,
        note: "Mandatory under Dubai health insurance law.",
      },
      { ...TYPING, amount: 150 },
      {
        kind: "service",
    ...
    stages: [
      {
        ...
        description: "Offer, passport, photo and attested qualifications uploaded.",
        days: 0,
        actor: "customer",
      },
      {
        title: "Document validation",
        description: "Attestation chain and MoHRE eligibility verified.",
        days: 1,
        actor: "maqam",
      },
      {
        title: "MoHRE work permit",
        description: "Quota check, offer letter and work permit approval.",
        days: 7,
        actor: "government",
      },
      {
        title: "Entry permit issued",
        description: "ICP entry permit granted.",
        days: 3,
        actor: "government",
      },
      {
        title: "Medical & biometrics",
        description: "Medical fitness test and Emirates ID capture.",
        days: 3,
        actor: "customer",
      },
      {
        title: "Labour contract signed",
        description: "Contract registered with MoHRE.",
        days: 2,
        actor: "customer",
      },
      {
    ...
    documents: [
      ...
      },
      {
        id: "photo",
        label: "Passport photograph",
        description: "White background, ICP specification.",
      },
      {
        id: "offer",
        label: "Signed employment offer",
        description: "MoHRE-format offer letter from your employer.",
      },
      {
        id: "degree",
        label: "Attested degree certificate",
        description: "Full chain: notary, home MOFA, UAE embassy, UAE MOFA.",
        attestationRequired: true,
      },
      {
        id: "experience",
        label: "Experience certificates",
        description: "Supporting the declared job title and skill level.",
        conditional:
          "Required where the job title rests on experience rather than a qualification.",
      },
    ],
    commonRejectionReasons: [
  ...
  },
  {
    ...
    audience:
      "High earners, property investors, specialised talent, entrepreneurs and content creators.",
    fees: [
      {
        kind: "government",
        label: "ICP Golden Visa fee",
        amount: 4695,
        vatable: false,
        estimated: true,
        note: "Salary and talent routes. The property investment route carries a materially higher fee.",
      },
      {
        kind: "government",
        label: "Emirates ID (10 years)",
        amount: 1150,
        vatable: false,
      },
      {
        kind: "third-party",
        label: "Medical fitness test (premium)",
        amount: 750,
        vatable: true,
      },
      {
        kind: "third-party",
        label: "Health insurance (1 year)",
        amount: 1200,
        vatable: true,
        estimated: true,
      },
      { ...TYPING, amount: 200 },
      {
        ...
        amount: 5000,
        vatable: true,
        note: "Route selection, nomination handling, evidence pack preparation and full case management.",
      },
    ],
    ...
    stages: [
      {
        ...
        description:
          "We rank every Golden Visa route you qualify for and recommend the strongest.",
        days: 1,
        actor: "maqam",
      },
      {
        ...
        description:
          "Salary certificates, title deeds, portfolio or nomination evidence prepared.",
        days: 5,
        actor: "customer",
      },
      {
        title: "Nomination submitted",
        description: "Application lodged with the relevant nominating authority.",
        days: 2,
        actor: "maqam",
      },
      {
        title: "Authority review",
        description: "The nominating body assesses your evidence.",
        days: 21,
        actor: "government",
      },
      {
        title: "Approval & entry permit",
        description: "Golden Visa pre-approval and entry permit issued.",
        days: 7,
        actor: "government",
      },
      {
        title: "Medical & Emirates ID",
        description: "Medical fitness and biometric capture.",
        days: 3,
        actor: "customer",
      },
      {
        title: "Residence issued",
        description: "10-year residence stamped and Emirates ID delivered.",
        days: 7,
        actor: "government",
      },
    ],
    documents: [
      ...
      {
        id: "salary",
        label: "Salary certificate & payslips",
        description: "Attested salary certificate plus 6 months of payslips.",
        conditional: "Salary route only.",
      },
      {
        id: "bank",
        label: "Bank statements",
        description: "6 months, stamped by the bank.",
        conditional: "Salary and investor routes.",
      },
      {
        id: "titledeed",
        label: "Property title deed",
        description: "DLD title deed meeting the investment threshold.",
        conditional: "Property investment route only.",
      },
      {
        id: "portfolio",
        label: "Portfolio & recognition evidence",
        description: "Published work, audience metrics, awards or media coverage.",
        conditional: "Creators and specialised talent routes.",
      },
      {
        id: "degree",
        label: "Attested degree certificate",
        description: "Required for most talent and specialist routes.",
        attestationRequired: true,
      },
    ],
    commonRejectionReasons: [
  ...
  },
  {
    ...
    fees: [
      ...
      { ...TYPING, amount: 150 },
      {
        ...
        amount: 1200,
        vatable: true,
        note: "Per dependant. Eligibility check, document preparation and submission.",
      },
    ],
    ...
    stages: [
      {
        ...
        description:
          "We verify your salary, tenancy and visa category meet the threshold.",
        days: 1,
        actor: "maqam",
      },
      {
        title: "Documents collected",
        description:
          "Attested marriage or birth certificate, Ejari, salary certificate.",
        days: 0,
        actor: "customer",
      },
      {
        title: "Entry permit application",
        description: "Submitted to GDRFA or ICP.",
        days: 5,
        actor: "government",
      },
      {
        title: "Medical & biometrics",
        description: "Medical fitness and Emirates ID capture for the dependant.",
        days: 3,
        actor: "customer",
      },
      {
    ...
    documents: [
      {
        id: "passport",
        label: "Dependant's passport",
        description: "Minimum 6 months validity.",
      },
      {
        id: "sponsor-eid",
        label: "Sponsor's Emirates ID & visa",
        description: "Valid residence visa with sufficient remaining validity.",
      },
      {
        id: "salary-cert",
        label: "Salary certificate",
        description: "Attested by your employer, meeting the sponsorship threshold.",
      },
      {
        id: "ejari",
        label: "Ejari tenancy contract",
        description: "Registered tenancy with an adequate number of bedrooms.",
      },
      {
        id: "marriage",
        label: "Marriage certificate",
        description: "Fully attested for UAE use.",
        attestationRequired: true,
        conditional: "Spouse sponsorship only.",
      },
      {
        id: "birth",
        ...
        description: "Fully attested for UAE use.",
        attestationRequired: true,
        conditional: "Child sponsorship only.",
      },
    ],
    commonRejectionReasons: [
  ...
  },
  {
    ...
    fees: [
      ...
      {
        kind: "government",
        label: "Emirates ID renewal (2 years)",
        amount: 370,
        vatable: false,
      },
      MEDICAL,
      {
        kind: "third-party",
        label: "Health insurance renewal (1 year)",
        amount: 900,
        vatable: true,
        estimated: true,
      },
      TYPING,
      {
        ...
        amount: 900,
        vatable: true,
        note: "Expiry monitoring, appointment booking and submission.",
      },
    ],
    ...
    stages: [
      {
        ...
        description: "We alert you 90 days before expiry.",
        days: 0,
        actor: "maqam",
      },
      {
        title: "Documents refreshed",
        description: "Updated passport, photo and insurance collected.",
        days: 0,
        actor: "customer",
      },
      {
        title: "Medical fitness test",
        description: "Repeat medical at an approved centre.",
        days: 2,
        actor: "customer",
      },
      {
        title: "Submitted for renewal",
        description: "Application lodged with the ICP.",
        days: 1,
        actor: "maqam",
      },
      {
        title: "Renewed & stamped",
        description: "New residence and Emirates ID issued.",
        days: 7,
        actor: "government",
      },
    ],
    documents: [
      ...
      {
        id: "insurance",
        label: "Valid health insurance",
        description: "Active policy covering the renewal period.",
      },
    ],
    commonRejectionReasons: [
  ...
  },
  {
    ...
    fees: [
      ...
      { ...TYPING, amount: 150 },
      {
        ...
        amount: 450,
        vatable: true,
        note: "Eligibility confirmation and same-day submission.",
      },
    ],
    ...
    stages: [
      {
        ...
        description:
          "We verify your nationality and current visa permit an in-country change.",
        days: 0,
        actor: "maqam",
      },
      {
        title: "Submitted",
        description: "Status change lodged with the ICP.",
        days: 1,
        actor: "maqam",
      },
      {
        title: "Status changed",
        description: "You are now on a residence track without exiting.",
        days: 1,
        actor: "government",
      },
    ],
    documents: [
      {
        id: "passport",
        label: "Passport bio page",
        description: "With the current visit visa or entry stamp.",
      },
      {
        id: "entry-permit",
        label: "New residence entry permit",
        description: "The approved entry permit you are converting onto.",
      },
    ],
    commonRejectionReasons: [
  ...
  // ───────────────────────────────── BUSINESS SETUP ─────────────────────────────────
  {
    ...
    summary:
      "100% foreign-owned company with trade licence and investor visa eligibility.",
    description:
    ...
    audience:
      "Founders, consultants and freelancers wanting full ownership and a fast setup.",
    fees: [
      {
        kind: "government",
        label: "Free zone trade licence (1 year)",
        amount: 8500,
        vatable: false,
        estimated: true,
        note: "Varies substantially by free zone and activity. Representative mid-tier zone shown.",
      },
      { kind: "government", label: "Establishment card", amount: 1200, vatable: false },
      {
        kind: "government",
        label: "Trade name reservation & initial approval",
        amount: 620,
        vatable: false,
      },
      {
        ...
        amount: 3500,
        vatable: true,
        note: "Zone comparison, activity selection, incorporation and bank account introduction.",
      },
    ],
    ...
    stages: [
      {
        title: "Zone & activity selection",
        description:
          "We compare free zones against your activity, visa quota and budget.",
        days: 1,
        actor: "maqam",
      },
      {
        title: "Trade name reservation",
        description: "Name checked and reserved with the authority.",
        days: 2,
        actor: "government",
      },
      {
        title: "Initial approval",
        description: "Activity and shareholder structure approved.",
        days: 3,
        actor: "government",
      },
      {
        title: "Documents signed",
        description: "Incorporation documents executed.",
        days: 1,
        actor: "customer",
      },
      {
        title: "Licence issued",
        description: "Trade licence and establishment card released.",
        days: 5,
        actor: "government",
      },
      {
        title: "Bank account introduction",
        description: "We introduce you to banks matched to your profile.",
        days: 3,
        actor: "maqam",
      },
    ],
    documents: [
      {
        id: "passport",
        label: "Shareholder passports",
        description: "Colour copies for every shareholder.",
      },
      {
        id: "photo",
        label: "Shareholder photographs",
        description: "White background, passport specification.",
      },
      {
        id: "business-plan",
        label: "Business plan",
        description: "Brief activity description.",
        conditional: "Required by some zones and for regulated activities.",
      },
      {
        id: "noc",
        label: "NOC from current sponsor",
        description: "If you hold a UAE residence visa under another sponsor.",
        conditional: "Existing UAE residents only.",
      },
    ],
    commonRejectionReasons: [
  ...
  },
  {
    ...
    audience:
      "Businesses trading with the UAE local market or bidding for government work.",
    fees: [
      {
        kind: "government",
        label: "DED trade licence (1 year)",
        amount: 9200,
        vatable: false,
        estimated: true,
        note: "Varies by activity and legal form.",
      },
      {
        kind: "government",
        label: "Initial approval & trade name",
        amount: 855,
        vatable: false,
      },
      {
        kind: "third-party",
        label: "MoA notarisation & typing",
        amount: 800,
        vatable: true,
      },
      {
        ...
        amount: 4500,
        vatable: true,
        note: "Structuring, DED liaison, MoA drafting and licence issuance.",
      },
    ],
    ...
    stages: [
      {
        title: "Structure & activity advice",
        description: "Legal form, ownership and activity codes decided.",
        days: 2,
        actor: "maqam",
      },
      {
        title: "Initial approval",
        description: "DED approves the activity and structure.",
        days: 3,
        actor: "government",
      },
      {
        title: "Premises & Ejari",
        description: "Office secured and tenancy registered.",
        days: 5,
        actor: "customer",
      },
      {
        title: "MoA notarised",
        description: "Memorandum of association executed before a notary.",
        days: 2,
        actor: "customer",
      },
      {
        title: "Licence issued",
        description: "DED trade licence released.",
        days: 5,
        actor: "government",
      },
    ],
    documents: [
      ...
      {
        id: "ejari",
        label: "Registered Ejari tenancy",
        description: "Physical premises are mandatory for mainland licences.",
      },
      {
        id: "noc",
        label: "NOC from current sponsor",
        description: "For existing UAE residence visa holders.",
        conditional: "Existing UAE residents only.",
      },
      {
        id: "approvals",
        label: "External approvals",
        description: "Sector regulator approval.",
        conditional:
          "Required for regulated activities such as healthcare, education or legal services.",
      },
    ],
    commonRejectionReasons: [
  ...
  // ───────────────────────────────── OUTBOUND VISAS ─────────────────────────────────
  {
    ...
    summary:
      "Short-stay Schengen visa for UAE residents, prepared to consulate standard.",
    description:
    ...
    fees: [
      {
        kind: "government",
        label: "Consulate visa fee",
        amount: 360,
        vatable: false,
        estimated: true,
        note: "Set in euro by the Schengen states; the dirham amount moves with the exchange rate.",
      },
      {
        kind: "third-party",
        label: "VFS / TLScontact service fee",
        amount: 145,
        vatable: true,
        estimated: true,
      },
      {
        ...
        vatable: true,
        estimated: true,
        note: "Minimum €30,000 medical cover is mandatory.",
      },
      {
        kind: "third-party",
        label: "Courier return of passport",
        amount: 60,
        vatable: true,
      },
      {
        ...
        amount: 600,
        vatable: true,
        note: "Itinerary construction, financial review, cover letter and appointment booking.",
      },
    ],
    processingDays: { min: 10, max: 21 },
    stages: [
      {
        title: "Country & consulate determined",
        description:
          "We identify the correct consulate based on your main destination.",
        days: 1,
        actor: "maqam",
      },
      {
        title: "Financial review",
        description: "Bank statements assessed against the consulate's expectations.",
        days: 1,
        actor: "maqam",
      },
      {
        title: "Appointment booked",
        description: "VFS or TLScontact slot secured.",
        days: 3,
        actor: "maqam",
      },
      {
        title: "Biometrics submitted",
        description: "You attend the appointment.",
        days: 1,
        actor: "customer",
      },
      {
        title: "Consulate decision",
        description: "Application assessed and decided.",
        days: 14,
        actor: "government",
      },
    ],
    documents: [
      {
        ...
        label: "Passport",
        description:
          "Valid 3 months beyond return, issued within the last 10 years, 2 blank pages.",
      },
      {
        id: "eid",
        label: "Emirates ID & residence visa",
        description: "Residence must be valid at least 3 months beyond return.",
      },
      {
        id: "bank",
        label: "Bank statements",
        description: "3–6 months, stamped, showing consistent balance.",
      },
      {
        id: "noc",
        label: "Employer NOC & salary certificate",
        description: "Confirming employment, salary and approved leave.",
      },
      {
        id: "itinerary",
        label: "Flight & hotel bookings",
        description: "Confirmed reservations covering the full stay.",
      },
      {
        id: "insurance",
        label: "Travel insurance",
        description: "Minimum €30,000 medical cover across the Schengen area.",
      },
    ],
    commonRejectionReasons: [
  ...
  },
  {
    ...
    fees: [
      {
        kind: "government",
        label: "UKVI application fee",
        amount: 550,
        vatable: false,
        estimated: true,
        note: "Set in sterling; the dirham amount moves with the exchange rate.",
      },
      {
        kind: "third-party",
        label: "VFS service & biometrics",
        amount: 120,
        vatable: true,
        estimated: true,
      },
      ...
      },
      {
        ...
        amount: 700,
        vatable: true,
        note: "Case assessment, supporting statement, document pack and appointment booking.",
      },
    ],
    ...
    stages: [
      {
        ...
        description: "We evaluate credibility factors and identify weaknesses.",
        days: 1,
        actor: "maqam",
      },
      {
        title: "Online application",
        description: "UKVI form completed and fee paid.",
        days: 1,
        actor: "maqam",
      },
      {
        title: "Supporting statement",
        description: "Written case addressing ties, funds and purpose.",
        days: 2,
        actor: "maqam",
      },
      {
        title: "Biometrics appointment",
        description: "You attend VFS for fingerprints and photo.",
        days: 1,
        actor: "customer",
      },
      {
        title: "UKVI decision",
        description: "Application decided and passport returned.",
        days: 15,
        actor: "government",
      },
    ],
    documents: [
      {
        id: "passport",
        label: "Passport",
        description: "Valid for the duration of the intended stay.",
      },
      {
        id: "eid",
        label: "Emirates ID & residence visa",
        description: "Proof of lawful UAE residence.",
      },
      {
        id: "bank",
        label: "Bank statements",
        description: "6 months, stamped, demonstrating funds are genuinely available.",
      },
      {
        id: "employment",
        label: "Employer letter",
        description: "Role, salary, length of service and approved leave dates.",
      },
      {
        id: "accommodation",
        label: "Accommodation & travel plan",
        description: "Bookings or a host's invitation with their status documents.",
      },
    ],
    commonRejectionReasons: [
  ...
  // ──────────────────────────────── ATTESTATION & PRO ────────────────────────────────
  {
    ...
    audience:
      "Anyone taking up skilled employment in the UAE with a foreign qualification.",
    fees: [
      {
        kind: "government",
        label: "UAE MOFA attestation",
        amount: 150,
        vatable: false,
        note: "Per document, paid to the UAE Ministry of Foreign Affairs.",
      },
      {
        kind: "third-party",
        label: "Home country attestation & embassy legalisation",
        amount: 700,
        vatable: true,
        estimated: true,
        note: "Varies significantly by country. India, Pakistan and the Philippines differ materially.",
      },
      {
        kind: "third-party",
      ...
      },
      {
        ...
        amount: 450,
        vatable: true,
        note: "Chain management, overseas agent coordination and tracking.",
      },
    ],
    ...
    stages: [
      {
        ...
        description: "Original certificate collected or couriered.",
        days: 1,
        actor: "customer",
      },
      {
        title: "Home country attestation",
        description: "Notary or HRD, then home country MOFA.",
        days: 10,
        actor: "government",
      },
      {
        title: "UAE embassy legalisation",
        description: "Legalised by the UAE embassy in the issuing country.",
        days: 5,
        actor: "government",
      },
      {
        title: "UAE MOFA attestation",
        description: "Final attestation in the UAE.",
        days: 2,
        actor: "maqam",
      },
      {
        title: "Delivered",
        description: "Attested original returned to you.",
        days: 1,
        actor: "maqam",
      },
    ],
    documents: [
      {
        ...
        description: "The physical original — copies are not accepted.",
      },
      {
        id: "transcript",
        label: "Academic transcript",
        description: "Often required alongside the certificate.",
        conditional: "Required by some authorities.",
      },
      {
        id: "passport",
        label: "Passport copy",
        description: "For identity verification through the chain.",
      },
    ],
    commonRejectionReasons: [
  ...
  },
  {
    ...
    fees: [
      ...
      { ...TYPING, amount: 60 },
      {
        ...
        amount: 200,
        vatable: true,
        note: "Chain verification, submission and collection.",
      },
    ],
    processingDays: { min: 1, max: 3 },
    stages: [
      {
        ...
        description: "We confirm the prior legalisation steps are valid.",
        days: 1,
        actor: "maqam",
      },
      {
        title: "Submitted to MOFA",
        description: "Document lodged for attestation.",
        days: 1,
        actor: "maqam",
      },
      {
        title: "Attested & returned",
        description: "Document collected and delivered.",
        days: 1,
        actor: "maqam",
      },
    ],
    documents: [
      {
        id: "document",
        label: "Original legalised document",
        description: "Already attested by the UAE embassy in the issuing country.",
      },
      {
        id: "passport",
        label: "Passport copy",
