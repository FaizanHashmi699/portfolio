  ...
  return (
    <html lang="en" className={`${manrope.variable} ${amiri.variable}`}>
      <body className="font-sans antialiased">
        ...
        <a
          href="#main"
          className="sr-only focus:not-sr-only focus:fixed focus:left-4 focus:top-4 focus:z-50 focus:rounded-chip focus:bg-brand focus:font-bold focus:shadow-brand focus:px-4 focus:py-2 focus:text-white"
        >
          Skip to content
        </a>
        {children}
